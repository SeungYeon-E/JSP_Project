...
//				System.out.println(pContent);
				dto = new ContentTipdto(t_num, user_email, name, t_title, t_content, t_image, t_category, t_hits, tw_regist);
...
//			System.out.println(dataSource1);
			...
			String query = "select * from comment_tip t, user u where  item_t_num = ? and u.email = t.user_email and tc_delete is null ORDER BY tc_num DESC LIMIT ?, ?";
